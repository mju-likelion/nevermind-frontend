      ...
      <Container>
        ...
        <Item className="mt-3">
          <div className="mb-3 d-flex">
            ...
            <div className="mt-2 ml-5">{this.props.username}</div>
          </div>
          <div className="mb-3 d-flex">
            <div className="mt-2">이메일</div>
            <div className="mt-2 ml-4">{this.props.email}</div>
          </div>
          <div className="mb-3 d-flex">
            <div className="mt-2">핸드폰</div>
            <div className="mt-2 ml-4">{this.props.cellphone}</div>
          </div>
        </Item>
